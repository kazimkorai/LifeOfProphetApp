...
import com.example.lifeofprophetapp.adapter.AdapterSahihMuslims;
...
public class SahihMuslimActivity extends AppCompatActivity implements View.OnClickListener{

    DBManagerSahihMuslims db;
    ArrayList<DataModel> listItems;
    RecyclerView recyclerViewSahiMuslim;
    ImageView ivBack;
    TextView tvTittle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = new DBManagerSahihMuslims(SahihMuslimActivity.this);
        ...
        initAds();
        recyclerViewSahiMuslim=(RecyclerView)findViewById(R.id.recyclerViewSahiMuslim);
        recyclerViewSahiMuslim.setHasFixedSize(false);
        recyclerViewSahiMuslim.setLayoutManager(new LinearLayoutManager(this));
        try {
            db.createDataBase();
            db.openDataBase();
    ...
    class MyAsyncTaskGet extends AsyncTask<String,String,String>
    {
        ...
        protected void onPostExecute(String s) {
            ...
            AdapterSahihMuslims adapter=new AdapterSahihMuslims(SahihMuslimActivity.this,listItems);
            recyclerViewSahiMuslim.setAdapter(adapter);
        }
    }
